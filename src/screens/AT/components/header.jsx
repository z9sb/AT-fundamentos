    ...
    return(
        <div className={HeaderStyle.headerTop}>
            ...
            <nav className={openMenu ? HeaderStyle.openMenu : HeaderStyle.closeMenu}>
                    ...
                    <button 
                className={openMenu ? HeaderStyle.openIconClose : HeaderStyle.closeIconClose}
                onClick={() => {setOpenMenu(!openMenu)}}
                >
                <IoMdClose size={30} />
            </button>
...
export function HeaderBotton({ setFiltro }){
    const menu_itens = ['Novidades', 'Mais vendidos', 'Oferta do dia', 'Login', 'Sua lista', 'Computadores']
    ...
    return (
        <div className={HeaderStyle.Menu}>
            <div className={HeaderStyle.topMenu}>
            </div>
            <input 
                type="text" 
            ...
            <menu className={HeaderStyle.MenuBar}>
                <ul className={HeaderStyle.MenuList}>
                    {Object.values(menu_itens).map((e, idx)=>{
                        return <li className={HeaderStyle.MenuItem} key={idx}>{e}</li>
                    })}
                </ul>
            </menu>
        </div>
